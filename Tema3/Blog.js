...
$("#templatemo_menu_section ul").addClass('card-panel red darken-2');
$("#templatemo_menu_section ul li a").addClass('waves-effect waves-light btn-flat red');
$(".templatemo_left_section_box_top ul").addClass('card-panel red darken-1');
